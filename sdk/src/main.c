...
static const double feat_mean[7] = {
    5.9142e2, 1.2185, 5.9479e-1, 5.8380e-4, -8.5389e-1, 2.7806e-3, 1.8248e6
};
/* inv_std[j] = 1/sqrt(var[j])，var = [5.3181e4, 8.5724e-3, 6.1759e4,
 *   2.0139e-3, 5.8890e-1, 1.6688e-6, 3.2837e12]，离线按 double 预算 */
static const double feat_inv_std[7] = {
    0.0043363242603886984, 10.800622479412617, 0.0040239249521173172,
    22.283379109940363, 1.3031044349091303, 774.10140277829066,
    5.5184646323749082e-07
};
...
/* 期望 40bit 累加器（expected.hex 行 0）：ΔV=490.4013 m/s */
#define EXP_ACC       0x001ea66b88LL
#define EXP_DV_MILLI  490401LL    /* 490.4013 m/s，单位 0.001 m/s */
